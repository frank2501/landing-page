    ...
    <footer className="py-20 md:py-32 px-6 relative overflow-hidden bg-transparent">
      <div className="max-w-4xl mx-auto text-center flex flex-col items-center">
        ...
        <button 
          ...
          className="w-full sm:w-auto inline-block px-7 py-3 md:px-12 md:py-5 bg-white text-black text-sm md:text-xl font-bold rounded-2xl hover:bg-orange-500 hover:text-white transition-all duration-300 shadow-2xl shadow-white/10 transform hover:scale-105 active:scale-95 mb-16 md:mb-20"
        >
          Consultar WhatsApp
        </button>
      </div>
